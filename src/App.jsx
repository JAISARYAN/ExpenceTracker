...
export default function App() {
  ...
  const exportPDF = async () => {
    ...
    doc.setFontSize(9);
    doc.text(`Generated by Aryan Jaiswal`, 40, pageHeight - 30);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-indigo-900 to-purple-900 flex font-sans text-white">
      ...
      {/* Footer */}
      <footer className="fixed right-4 bottom-3 text-xs text-white/60 hidden md:block">
        Built by Aryan Jaiswal — © 2025
      </footer>
